                                    ...
                                    <div className={cn(
                                        ...
                                        <div className="aspect-[16/9] md:aspect-[21/9] lg:aspect-[16/8] relative">
                                            ...
                                            <div className={cn(
                                                ...
                                                {/* Pinned CTA Button */}
                                                <Button size="lg" className="shrink-0 bg-blue-600 hover:bg-blue-500 text-white rounded-full px-6 shadow-lg hover:shadow-blue-500/25 transition-all group/btn">
