      ...
      <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto px-4 h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 group">
            ...
            <div className="flex flex-col">
              <span className="font-serif font-bold text-lg leading-tight text-primary">HRDA</span>
              <span className="text-[10px] text-muted-foreground uppercase tracking-wider font-semibold">Telangana</span>
            </div>
          </Link>
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden absolute top-20 left-0 w-full bg-background border-b shadow-lg p-4 flex flex-col gap-2 animate-in slide-in-from-top-5">
            ...
            <Link href="/membership">
              <Button className="w-full justify-center">Join HRDA</Button>
            </Link>
            {user ? (
               <Link href="/admin/dashboard">
              ...
              <a href="/api/login" className="w-full block mt-2">
