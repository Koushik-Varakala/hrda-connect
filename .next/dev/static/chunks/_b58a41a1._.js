...
"[project]/app/admin/gallery/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ManageGallery() {
    ...
    const { data: photos, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "ManageGallery.useQuery": async ()=>{
                const res = await fetch("/api/gallery");
                if (!res.ok) throw new Error("Failed to fetch gallery photos");
                return res.json();
            }
        }["ManageGallery.useQuery"]
    });
    const form = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hook$2d$form$2f$dist$2f$index$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useForm"])({
        resolver: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$hookform$2f$resolvers$2f$zod$2f$dist$2f$zod$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["zodResolver"])(__TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$schema$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["insertGalleryPhotoSchema"]),
        defaultValues: {
            url: "",
            title: "",
            description: "",
    ...
    const createMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "ManageGallery.useMutation[createMutation]": async (data)=>{
                const res = await fetch("/api/gallery", {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json"
        ...
        }["ManageGallery.useMutation[createMutation]"],
        onSuccess: {
            "ManageGallery.useMutation[createMutation]": ()=>{
        ...
        onError: {
            "ManageGallery.useMutation[createMutation]": (error)=>{
                toast({
                    title: "Error",
    ...
    const deleteMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "ManageGallery.useMutation[deleteMutation]": async (id)=>{
                const res = await fetch(`/api/gallery/${id}`, {
                    method: "DELETE"
                });
                if (!res.ok) throw new Error("Failed to delete photo");
            }
        }["ManageGallery.useMutation[deleteMutation]"],
        onSuccess: {
            "ManageGallery.useMutation[deleteMutation]": ()=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$queryClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["queryClient"].invalidateQueries({
                    queryKey: [
        ...
        onError: {
            "ManageGallery.useMutation[deleteMutation]": (error)=>{
                toast({
                    title: "Error",
                    description: error.message,
                    variant: "destructive"
...
_s(ManageGallery, "ZauSENOxKFeU1ObspEIE95JaVto=", false, function() {
    return [
...
_c = ManageGallery;
var _c;
__turbopack_context__.k.register(_c, "ManageGallery");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_b58a41a1._.js.map