...
"[project]/app/api/election-documents/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function DELETE(request, props) {
    ...
    try {
        const docs = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["storage"].getElectionDocuments();
        ...
        if (doc) {
            ...
            if (doc.filename.includes("cloudinary")) {
                try {
                    ...
                    if (match && match[1]) {
                        await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cloudinary$2f$cloudinary$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["v2"].uploader.destroy(match[1]);
                    }
                } catch (e) {
                    console.error("Cloudinary delete failed", e);
                }
            }
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["storage"].deleteElectionDocument(id);
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e51d0708._.js.map