...
"[project]/app/api/announcements/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request, props) {
    ...
    try {
        ...
        const data = __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["insertAnnouncementSchema"].partial().parse(body);
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["storage"].updateAnnouncement(id, data);
...
async function DELETE(request, props) {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["storage"].deleteAnnouncement(id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0917c4e8._.js.map